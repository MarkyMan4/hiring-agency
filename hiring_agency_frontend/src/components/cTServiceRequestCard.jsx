...
function CTServiceRequestCard({ requestId, patientName, requesterName, requesterUsername, serviceType }) {
    return (
        <div className="care-taker-request-card shadow animate__animated animate__fadeInUp">
            <h4>Patient: <Link to={ '/ct_service_requests/' + requestId }>{ patientName }</Link></h4>
            <hr />
...
export default CTServiceRequestCard;